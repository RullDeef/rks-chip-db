package ru.spacecorp.mobdekbkp.web.corpus;
...
public class CorpusBrowse extends AbstractLookup implements ImportFrame {
    @Inject
    private Table<Corpus> corpusesTable;
    @Inject
    private CollectionDatasource<Corpus, UUID> corpusesDs;
    @Inject
    ...
    public void initFrame(ImportDevice importDevice) {
        if (importDevice != null) {
            corpusesTable.setVisible(true);
            this.importDevice = importDevice;
            corpusesDs.setQuery("select e from mobdekbkp$Corpus e " +
    ...
    public void clearFrame(String labelValue) {
        ...
        corpusesTable.setVisible(false);
    ...
    public void onCreateBtnClick() {
        ...
        corpus.setImportDevice(importDevice);
        Map<String, Object> paramOpen = new HashMap<>();
        paramOpen.put("noedit", true);
        AbstractEditor ed = openEditor("mobdekbkp$Corpus.edit", corpus,
