...
public class DevicePartListComplectEdit extends AbstractEditor<DevicePartListComplect> {
    ...
    @Named("documentTableComplect.create")
    private CreateAction createActionComplect;
    @Inject
    private Table<DevicePartListComplectEntry> partListComplectEntriesTable;
    @Inject
    private GroupDatasource<DevicePartListComplectEntry, UUID> entriesDs;
    @Inject
    private Datasource<DevicePartListComplect> devicePartListComplectDs;
    @Inject
    private CollectionDatasource typonominalsCustDs;
    @Inject
    private TextField amountDeliveredField;
    @Inject
    private TextField amountInDeviceField;
    @Inject
    private TextField amountTotalField;
    @Inject
    private DateField dateFactField;
    @Inject
    private DateField datePlannedField;
    @Inject
    private ResizableTextArea questionsArea;
    @Inject
