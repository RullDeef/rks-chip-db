package ru.spacecorp.mobdekbkp;
...
public class MobdekbkpTestContainer extends TestContainer {

    public MobdekbkpTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/spacecorp/mobdekbkp/app.properties",
    ...
    public static class Common extends MobdekbkpTestContainer {

        public static final MobdekbkpTestContainer.Common INSTANCE = new MobdekbkpTestContainer.Common();
