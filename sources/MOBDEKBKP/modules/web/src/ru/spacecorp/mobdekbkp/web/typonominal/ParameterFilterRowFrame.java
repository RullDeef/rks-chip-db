...
public class ParameterFilterRowFrame extends AbstractFrame {
    @Inject private Datasource<ParameterFilterRow> parameterFilterRowDs;
    @Inject private CollectionDatasource<Parameter, UUID> parametersDs;
    @Inject protected HBoxLayout mainBox;
    @Inject private LookupField operationLookup;
    @Inject private HBoxLayout valFloatHbox;
    @Inject private HBoxLayout valStringHbox;
