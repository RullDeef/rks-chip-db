...
public class ApplicationNewTyponominalDevEdit extends AbstractEditor<ApplicationNewTyponominalDev> {
    ...
    @Inject private TextField classNameField;
    @Inject private TextField statusField;
    @Inject private TextArea eventArea;
    @Inject private TextArea characteristicsArea;
    @Inject private TextArea possibilityArea;
    @Inject private TextArea prototypeArea;
    @Inject private PickerField documentField;
    @Inject private PickerField commonApplicationField;
    @Inject private Button btnReady;
    @Inject private Button btnToCommon;
    @Inject private Button btnAddtoComm;
    @Inject private UserSession userSession;
    @Inject private Metadata metadata;
    @Inject private DataManager dataManager;
    @Inject private AddEntriesService addEntriesService;
