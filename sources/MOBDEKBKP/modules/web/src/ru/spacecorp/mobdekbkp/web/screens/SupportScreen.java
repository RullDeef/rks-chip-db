...
public class SupportScreen extends AbstractWindow {
    @Inject private Datasource<SupportInfo> supportInfoDs;
    @Inject private Metadata metadata;
    @Inject private UserSession userSession;
    @Inject private RichTextArea rtaInfo;
    @Inject private TextField tfMail;
    @Inject private TextField tfPhone;
    @Inject private ComponentsFactory componentsFactory;
    @Inject private GroupBoxLayout gbButtons;
    @Inject private DataManager dataManager;
    @Inject private GroupBoxLayout sendMessage;
    @Inject private Button btnChat;
    @Inject private Button btnSendMsg;
    @Inject private LookupField lfThemes;
    @Inject private TextField tfTheme;
    @Inject private HBoxLayout hbThemePick;
    @Inject private RichTextArea rtaMessage;
    @Inject private MessageService messageService;
    @Inject protected FileUploadField fileUpload;
    @Inject protected Label fileName;
    @Inject protected HBoxLayout dropZone;
    @Inject private FileUploadingAPI fileUploadingAPI;
    @Inject private DataSupplier dataSupplier;
    ...
    @Inject private ExportDisplay exportDisplay;
