...
public class Foutercertificatetests extends AbstractFrame implements TyponominalFrame {
    ...
    @Inject private CollectionDatasource<OuterCertificateTests, UUID> outerCertificateTestsesDs;
    @Inject private Button btnCreate;
    @Inject private Table<OuterCertificateTests> tblOuterCertificateTests;
