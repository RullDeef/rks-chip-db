...
public class Analogframe extends AbstractFrame implements TyponominalFrame {
    ...
    @Inject private Table<TyponominalAnalog> table;
    @Inject private CollectionDatasource<TyponominalAnalog, UUID> typonominalAnalogsDs;
    @Inject private VBoxLayout vbox;
    ...
    @Inject private Button openEditorBtn;
