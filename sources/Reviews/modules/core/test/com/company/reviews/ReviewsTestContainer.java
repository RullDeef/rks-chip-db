...
public class ReviewsTestContainer extends TestContainer {

    public ReviewsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/reviews/app.properties",
    ...
    public static class Common extends ReviewsTestContainer {

        public static final ReviewsTestContainer.Common INSTANCE = new ReviewsTestContainer.Common();
