...
public class DiscussTestContainer extends TestContainer {

    public DiscussTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/iovchinnikov/talks/app.properties",
    ...
    public static class Common extends DiscussTestContainer {

        public static final DiscussTestContainer.Common INSTANCE = new DiscussTestContainer.Common();
