package ru.spacecorp.documents;
...
public class DocumentsTestContainer extends TestContainer {

    public DocumentsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/spacecorp/documents/app.properties",
    ...
    public static class Common extends DocumentsTestContainer {

        public static final DocumentsTestContainer.Common INSTANCE = new DocumentsTestContainer.Common();
