package ru.iovchinnikov.notificationsusers;
...
public class NotificationsusersTestContainer extends TestContainer {

    public NotificationsusersTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/iovchinnikov/notificationsusers/app.properties",
    ...
    public static class Common extends NotificationsusersTestContainer {

        public static final NotificationsusersTestContainer.Common INSTANCE = new NotificationsusersTestContainer.Common();
